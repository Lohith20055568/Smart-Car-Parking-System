...
function App() {
  ...
  const videoData =
    result?.record?.frame_summaries?.map(x => ({
      frame: x.frame_index,
      occupancy: x.occupancy_rate
    })) || [];
    ...
    <div className="page">
      ...
      <header>
        <div>
          ...
          <p>Parking occupancy detection using computer vision</p>
        </div>
      ...
      <section className="cards">
        ...
        <Card icon={<Car/>}
          label="Total Slots"
          value={latest.total_slots || slots.length}/>

        <Card icon={<Activity/>}
          label="Occupied"
          value={latest.occupied_slots || 0}/>

        <Card icon={<Upload/>}
          label="Vacant"
          value={latest.vacant_slots || slots.length}/>
      ...
      <main className="grid">
        ...
        <section className="panel">
          ...
          {videoData.length > 0 ? (
            ...
            <p>Upload a video to view occupancy.</p>
